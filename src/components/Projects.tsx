...
const projects = [
  ...
  {
    title: "Metaroom",
    description: "E-learning solution with AWS-hosted video streaming using Next.js and TypeScript.",
    github: "https://github.com/ahsan131-hub/metaroom-client",
    techStack: ["Next.js", "TypeScript", "AWS", "Tailwind CSS"]
  },
  {
    title: "TSAS",
    description: "Tweet sentiment analysis system using Python and Roberta NLP. Analyzed 10K+ tweets with high accuracy.",
    github: "https://github.com/ahsan131-hub/Tweets-Sentimental-Analysis-System",
    techStack: ["Python", "Roberta NLP", "Machine Learning", "Data Analysis"]
  },
  {
    title: "Pharmacy App",
    description: "POS system for pharmacies (Java, MySQL) – Reduced checkout time by 20% for 50+ users.",
    github: "#",
